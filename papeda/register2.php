                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            if (isset($_POST['daftar'])) {
                                ...
                                $gambar_penjual = uniqid() . '_' . $_FILES['gambar']['name']; // Menggunakan uniqid() untuk membuat nama unik
                                $tmp_gambar = $_FILES['gambar']['tmp_name'];

                                $lokasi_simpan = 'penjual/images/profile/' . $gambar_penjual;
                                ...
                                $koneksi->query("INSERT INTO penjual (nama_penjual, username,email, no_hp,alamat_penjual, gambar_penjual, kata_sandi) 
                                                VALUES ('$nama','$username','$email','$nohp','$alamat','$gambar_penjual','$hashed_password')");
