...
<div class="alert alert-primary shadow text-dark rounded mt-2 p-2">
    <p><strong>Pembayaran akan dikirimkan jika Anda telah melakukan pengiriman dan Barang telah diterima!</strong></p>
</div>
...
<form action="" method="post">
        <div class="form-group row">
            ...
            <select name="status" class="form-control">
                    ...
                    <option value="barang diterima">Pengiriman dibatalkan</option>
