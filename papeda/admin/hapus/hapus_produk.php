<?php 
    ...
    if(file_exists("../penjual/images/produk/" .$hapus)){

    unlink("../penjual/images/produk/" . $hapus);
    }
    ...
    foreach($data_gambar as $key => $values){
        ...
        if(file_exists("../penjual/images/produk/" .$hapusfoto)){

            unlink("../penjual/images/produk/" . $hapusfoto);
            }
