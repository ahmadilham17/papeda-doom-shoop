        ...
        <div class="form-group row">
            ...
            <div class="row">
                        <?php foreach ($data_gambar as $key => $gambar): ?>
                            <div class="col">
                                <img src="../penjual/images/produk/<?php echo $gambar['nama_gambar'] ?>" class="img-responsive" width="150 ">
                            </div>
                        <?php endforeach ?>
                    </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col text-right">
                    <form action="" method="post">
                        <button type="submit" name="valid" class="btn btn-sm btn-success">
                            Konfirmasi produk <i class="fas fa-chevron-right"></i>
                        </button>
                    </form>
                </div>
            </div>
...
<?php
    if(isset($_POST['valid'])){
        ...
        $koneksi->query("UPDATE produk SET status_produk = 'valid' 
        WHERE id_produk = '$id_produk'");

        echo "<script>alert(' Produk DiKonfirmasi');</script>";
